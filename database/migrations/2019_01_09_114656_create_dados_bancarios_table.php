...
class CreateDadosBancariosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dados_bancarios', function (Blueprint $table) {
            ...
            $table->integer('user_id')->unsigned()->index('dados_bancarios_user_id_foreign');
            $table->integer('user_id_editor')->unsigned()->index('dados_bancarios_user_id_editor_foreign');
            $table->timestamps();
            $table->integer('banco_id')->unsigned()->nullable()->index('dados_bancarios_banco_id_foreign');
