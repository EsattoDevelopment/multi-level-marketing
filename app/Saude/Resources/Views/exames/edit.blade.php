...
@section('content')
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <form role="form" action="{{ route('saude.exames.update', $dados) }}" method="post">
                    {!! csrf_field() !!}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group col-xs-12">
                                ...
                                <input type="text" name="nome" value="{{ old('nome', $dados->nome) }}" class="form-control"
                                       placeholder="Nome">
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="{{ route('saude.exames.index') }}" class="btn btn-default pull-right">Voltar</a>
                        </div>
                    </div><!-- /.box -->
                </form>
            </div><!--/.col (left) -->
