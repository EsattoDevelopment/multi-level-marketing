                    ...
                    <form action="{{ route('relatorio.faturamento') }}" method="post" target="_blank">
                        ...
                        <div class="box-body">
                            <div class="form-group col-lg-3 col-xs-12">
                                ...
                                <select class="form-control select2" required name="sort_by" style="width: 100%;">
                            ...
                            <div class="form-group col-lg-3 col-xs-12">
                                <label>Tipo de soma</label>
                                <select class="form-control select2" required name="soma" style="width: 100%;">
