...
/**
     ...
     */
    class FaturamentoRelatorioService
    {
        private $dados;
        private $sistema;
                ...
                if ($this->dados['tipo'] == 2) {
                    ...
                    $queryBuilder->join('pedidos as p', 'p.id', '=', 'dp.pedido_id')
                        ...
                        ->select([
                            ...
                            //'u.codigo as contrato',
                           // 'i.qtd_parcelas',
                            //'i.vl_parcelas',
                            'u.name as usuario',
                            'p.valor_total as valor',
                            'r.name as responsavel',
                            'mp.name as metodo',
                            'dp.documento',
  ...
  /*                      ->editColumn('Valor Total', [
                    ...
                    /*           if ($this->dados['soma'] == 1) {
                                   $relatorio->groupBy('Dt Pagamento');
                               }*/
                    /*$relatorio->groupBy('Dt Pagamento');*/
