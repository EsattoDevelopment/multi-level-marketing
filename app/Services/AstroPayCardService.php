...
class AstroPayCardService
{
    ...
    public function __construct($sandbox, $x_login, $x_trans_key) {
     ...
     * @return array Array of params returned by AstroPay capture API. Please see section 3.1.3 "Response" of AstroPay Card integration manual for more info
     */
    public function auth_capture_transaction($x_card_num, $x_card_code, $x_exp_date, $x_amount, $x_unique_id, $x_invoice_num, $x_currency, $additional_params = null) {
        try {
            $data['x_login'] = $this->x_login;
            $data['x_tran_key'] = $this->x_trans_key;
            $data['x_card_num'] = $x_card_num;
            ...
            Log::error("Erro ao chamar API AsptroPay Card: " . $e->getMessage());
            return false;
        }
    }
