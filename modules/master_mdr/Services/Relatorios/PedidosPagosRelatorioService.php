 ...
 */
class PedidosPagosRelatorioService
{
    private $dados;
    private $sistema;
    ...
    public function gerar()
    {
        try {
            ...
            $fim = $this->dados['fim'];
            // Report title
            $title = 'Relatório de Pedidos Pagos';
            ...
            if (isset($this->dados['itens']) && $this->dados['itens'] > 0) {
                $queryBuilder
                    ->whereIn('i.id', $this->dados['itens']);
            }
            ...
            if ($this->dados['tipo'] == 2) {
                $columns = [
                    ...
                    'Usuário' => 'usuario',
                    'Pedido' => function ($resul) {
                        return "{$resul->pedido_id} - {$resul->pedido}";
                    },
                    'Valor pago' => 'valor',
