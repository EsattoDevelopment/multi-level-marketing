        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form" action="{{ route('boletos.store') }}" method="post">
                        {!! csrf_field() !!}
                        <div class="box-body">
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                ...
                                <input type="text" name="min_diretos_aprovados" value="{{ old('min_diretos_aprovados') }}" class="form-control"  placeholder="Minimo diretos aprovados">
                            </div>
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                <label for="exampleInputEmail1">Minimo pontuação perna menor</label>
                                <input type="text" name="min_pontuacao_perna_menor" value="{{ old('min_pontuacao_perna_menor') }}" class="form-control"  placeholder="Minimo pontuação perna menor">
                            </div>
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                ...
                                <input type="text" name="dinheiro_indicador" value="{{ old('dinheiro_indicador') }}" class="form-control"  placeholder="Dinheiro para indicador {{ $sistema->moeda }}">
                            </div>
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                                ...
                                <input type="text" name="percentual_binario" value="{{ old('percentual_binario') }}" class="form-control"  placeholder="Percentual do Binário">
                            </div>
                            <div class="form-group col-xs-12 col-sm-6 col-md-4">
                            ...
                            <div class="form-group col-xs-12 col-sm-4 col-md-2">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <label class="btn btn-primary @if(!old('titulo_inicial')) active @endif {{ old('titulo_inicial') == 1 ? 'active' : ''  }}">
                                        <input type="radio" value="1" @if(!old('titulo_inicial')) checked @endif {{ old('titulo_inicial') == 1 ? 'checked' : ''  }} name="titulo_inicial" id="pt" autocomplete="off">Sim
                                    </label>
                                    <label class="btn btn-primary {{ old('titulo_inicial') == 2 ? 'active' : ''  }}">
                                        <input type="radio" value="2" {{ old('titulo_inicial') == 2 ? 'checked' : ''  }} name="titulo_inicial" id="en" autocomplete="off">Não
                                    </label>
                                </div>
                            </div>
