...
@section('content')
    <section class="content">
        ...
        <div class="row">
            <!-- form start -->
            <div class="col-xs-12">
                <form role="form" action="{{ route('item.update', $dados->id) }}" method="post"
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                ...
                                <input required type="text" name="name" value="{{ old('name', $dados->name) }}"
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input required type="text" name="valor" value="{{ old('valor', $dados->valor) }}"
                            ...
                            @if($sistema->rede_binaria)
                                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <input required type="text" name="pontos_binarios"
                                           value="{{ old('pontos_binarios', $dados->pontos_binarios) }}"
                                           class="form-control" placeholder="Pontos binarios">
                                </div>
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input required type="text" name="teto_binario_dia"
                                               value="{{ old('teto_binario_dia', $dados->teto_binario_dia) }}"
                            ...
                            {{--<div class="form-group col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="teto_ganho_geral"
                                           value="{{ old('teto_ganho_geral', $dados->teto_ganho_geral) }}"
                                           class="form-control" placeholder="Teto de ganho">
                                </div>
                            </div>--}}
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                ...
                                <select required class="form-control select2" name="tipo_pedido_id"
                                    ...
                                    @foreach($tipo_pedidos as $tp)
                                        <option @if(old('tipo_pedido_id', $dados->tipo_pedido_id) == $tp->id) selected
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <select required class="form-control select2" name="avanca_titulo"
                                        ...
                                        @foreach($titulos as $titulo)
                                            <option @if(old('avanca_titulo', $dados->avanca_titulo) == $titulo->id) selected
                            ...
                            @if($sistema->item_direcionado)
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <small><i>Item será apenas visto pelo usuário indicado (apenas usuario empresa)</i></small>
                                    <select class="form-control" id="empresa" name="user_id" style="width: 100%">
                                        @if($dados->user_id)
                                            <option value="{{ $dados->user_id }}"
                                                    selected="selected">{{ '#'.$dados->getRelation('empresa')->id .' - '. $dados->getRelation('empresa')->name }}</option> @endif
                                    </select>
                                </div>
                            @endif
                           ...
                           {{-- <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                ...
                                <input type="text" class="form-control" name="qtd_parcelas"
                                       value="{{ old('qtd_parcelas', $dados->qtd_parcelas) }}">
                            </div>
                            <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                ...
                                <input type="text" class="form-control" name="vl_parcelas"
                                       value="{{ old('vl_parcelas', $dados->vl_parcelas) }}">
                            </div>--}}
                            ...
                            @if($sistema->sistema_saude)
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" name="temp_contrato"
                                           value="{{ old('temp_contrato', $dados->temp_contrato) }}">
                                </div>
                            @endif
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                ...
                                <label style="padding-right: 25px">
                                    <input type="radio" value="1" name="ativo" class="flat-red" {{ old('ativo', $dados->ativo)  == 1 ? 'checked' : '' }}>
                                    Sim
                                </label>
                                <label>
                                    <input type="radio" value="0" name="ativo" class="flat-red" {{ old('ativo', $dados->ativo)  == 0 ? 'checked' : '' }}>
                                    Não
                                </label>
                            </div>
                           ...
                           {{-- <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                ...
                                <br>
                                <label style="padding-right: 25px">
                                    <input type="radio" value="1" name="quitar_com_bonus" class="flat-red" {{ old('quitar_com_bonus', $dados->quitar_com_bonus)  == 1 ? 'checked' : '' }}>
                                    Sim
                                </label>
                                <label>
                                    <input type="radio" value="0" name="quitar_com_bonus" class="flat-red" {{ old('quitar_com_bonus', $dados->quitar_com_bonus)  == 0 ? 'checked' : '' }}>
                                    Não
                                </label>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                ...
                                <br>
                                <label style="padding-right: 25px">
                                    <input type="radio" value="1" name="ativo_qtd" class="flat-red" {{ old('ativo_qtd', $dados->ativo_qtd)  == 1 ? 'checked' : '' }}>
                                    Sim
                                </label>
                                <label>
                                    <input type="radio" value="0" name="ativo_qtd" class="flat-red" {{ old('ativo_qtd', $dados->ativo_qtd)  == 0 ? 'checked' : '' }}>
                                    Não
                                </label>
                            </div>--}}
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-3">
                                <label for="language">Cor do item <br>
                                    <small><i>Escolha uma cor para aparecer na página de compra.</i></small>
                                </label><br>
                                <input name="cor_item" value="{{ old('cor_item', $dados->cor_item) }}" type="text" class="form-control colorpicker colorpicker-element">
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                ...
                                <select class="form-control select2" name="tipo_pacote"
                                    ...
                                    @foreach(config('constants.tipo_pacote') as $key => $value)
                                        <option @if(old('tipo_pacote', $dados->tipo_pacote) == $key) selected @endif value="{{ $key }}">{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                                        ...
                                        <div class="col-xs-6">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="faixa_deposito_min"
                                                       value="{{ old('faixa_deposito_min', $dados->faixa_deposito_min) }}" placeholder="Mínimo"
                                        ...
                                        <div class="col-xs-6">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="faixa_deposito_max"
                                                       value="{{ old('faixa_deposito_max', $dados->faixa_deposito_max) }}" placeholder="Máximo"
                                                       data-affixes-stay="true" data-prefix="" data-thousands="."
                                                       data-decimal=",">
                                            </div>
                                        </div>
       ...
       {{--                     <div class="form-group col-xs-12 col-sm-12 col-md-12 no-padding">
                                <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="potencial_mensal_teto"
                                               value="{{ old('potencial_mensal_teto', $dados->potencial_mensal_teto) }}" min="1" max="100"
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="carencia_minima"
                                               value="{{ old('carencia_minima', $dados->carencia_minima) }}" min="1"
                                               class="form-control">
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="contrato"
                                               value="{{ old('contrato', $dados->contrato) }}" min="0"
                                               class="form-control" placeholder="">
                                        <span class="input-group-addon">dias</span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="taxa_resgate"
                                           value="{{ old('taxa_resgate', $dados->taxa_resgate) }}" min="0" max="100"
                                           class="form-control" placeholder="">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>--}}
                            ...
                            @if($dados->imagem)
                                <div class="product-img col-xs-12">
                                    <img src="{{ route('imagecache',['small', 'itens/'.$dados->id.'/'.$dados->imagem] ) }}"
                                         alt="Product Image">
                                </div>
                            @endif
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <textarea class="form-control" id="chamada" name="chamada" rows="3" maxlength="255"
                                          placeholder="Chamada...">{{ old('chamada', $dados->chamada) }}</textarea>
                            ...
                            <div class="form-group col-xs-12">
                                <label for="descricao2">Aviso</label> <br>
                                <small>Aparecerá no modal de confirmação</small>
                                <textarea class="textarea" name="descricao2" placeholder="Aviso..."
                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('descricao2', $dados->descricao2) }}</textarea>
                            </div>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                ...
                                <br>
                                <label style="padding-right: 25px">
                                    <input type="radio" value="1" name="pagar_bonus" class="flat-red" {{ old('ativo', $dados->pagar_bonus)  == 1 ? 'checked' : '' }}>
                                    Sim
                                </label>
                                <label>
                                    <input type="radio" value="0" name="pagar_bonus" class="flat-red" {{ old('ativo', $dados->pagar_bonus)  == 0 ? 'checked' : '' }}>
                                    Não
                                </label>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                ...
                                <br>
                                <label style="padding-right: 25px">
                                    <input type="radio" value="1" name="pagar_bonus_titulo" class="flat-red" {{ old('ativo', $dados->pagar_bonus_titulo)  == 1 ? 'checked' : '' }}>
                                    Sim
                                </label>
                                <label>
                                    <input type="radio" value="0" name="pagar_bonus_titulo" class="flat-red" {{ old('ativo', $dados->pagar_bonus_titulo)  == 0 ? 'checked' : '' }}>
                                    Não
                                </label>
                            </div>
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="bonus_indicador"
                                               value="{{ old('bonus_indicador', $dados->bonus_indicador) }}"
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="bonus_equiparacao"
                                               value="{{ old('bonus_equiparacao', $dados->bonus_equiparacao) }}"
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="bonus_equiparacao_percentual"
                                               value="{{ old('bonus_equiparacao_percentual', $dados->bonus_equiparacao_percentual) }}"
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" min="0" required name="pontos_pessoais"
                                                   value="{{ old('pontos_pessoais', $dados->pontos_pessoais) }}"
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" required min="0" name="pontos_equipe"
                                                   value="{{ old('pontos_equipe', $dados->pontos_equipe) }}"
...
{{--                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                ...
                                <br>
                                <label style="padding-right: 25px">
                                    <input type="radio" value="1" name="resgate_minimo_automatico" class="flat-red" {{ old('resgate_minimo_automatico', $dados->resgate_minimo_automatico)  == 1 ? 'checked' : '' }}>
                                    Sim
                                </label>
                                <label>
                                    <input type="radio" value="0" name="resgate_minimo_automatico" class="flat-red" {{ old('resgate_minimo_automatico', $dados->resgate_minimo_automatico)  == 0 ? 'checked' : '' }}>
                                    Não
                                </label>
                            </div>
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="resgate_minimo"
                                               value="{{ old('resgate_minimo', $dados->resgate_minimo) }}" min="1" max="100"
                                               class="form-control">
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
...
{{--                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                ...
                                <br>
                                <label style="padding-right: 25px">
                                    <input type="radio" value="1" name="finaliza_contrato_automatico" class="flat-red" {{ old('finaliza_contrato_automatico', $dados->finaliza_contrato_automatico)  == 1 ? 'checked' : '' }}>
                                    Sim
                                </label>
                                <label>
                                    <input type="radio" value="0" name="finaliza_contrato_automatico" class="flat-red" {{ old('finaliza_contrato_automatico', $dados->finaliza_contrato_automatico)  == 0 ? 'checked' : '' }}>
                                    Não
                                </label>
                            </div>

                            <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                <label for="dias_carencia_transferencia">Carência para transferência</label><br>
                                ...
                                <div class="input-group">
                                    <input type="number" name="dias_carencia_transferencia"
                                           value="{{ old('dias_carencia_transferencia', $dados->dias_carencia_transferencia) }}" min="0"
                                           class="form-control" placeholder="">
                                    <span class="input-group-addon">dias</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6 col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="dias_carencia_saque"
                                           value="{{ old('dias_carencia_saque', $dados->dias_carencia_saque) }}" min="0"
                                           class="form-control" placeholder="">
                                    <span class="input-group-addon">dias</span>
                                </div>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="form-group col-xs-12 col-sm-6">
                                <div class="input-group">
                                    ...
                                    <br>
                                    <label style="padding-right: 25px">
                                        <input type="radio" value="1" name="habilita_recontratacao_automatica" class="flat-red" {{ old('habilita_recontratacao_automatica', $dados->habilita_recontratacao_automatica)  == 1 ? 'checked' : '' }}>
                                        Sim
                                    </label>
                                    <label>
                                        <input type="radio" value="0" name="habilita_recontratacao_automatica" class="flat-red" {{ old('habilita_recontratacao_automatica', $dados->habilita_recontratacao_automatica)  == 0 ? 'checked' : '' }}>
                                        Não
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6">
                                <div class="input-group">
                                    <label for="modo_recontratacao_automatica">Modo padrão para função recontratação automática</label> <br>
                                    <small><i>Define o modo padrão para função "recontratação automática" na aquisição de novos contratos pelos clientes</i></small>
                                    <br>
                                    <label>
                                        <input type="radio" value="0" name="modo_recontratacao_automatica" class="flat-red" {{ old('modo_recontratacao_automatica', $dados->modo_recontratacao_automatica)  == 0 ? 'checked' : '' }}>
                                        Não recontratar automaticamente.
                                    </label>
                                    <br>
                                    <label>
                                        <input type="radio" value="1" name="modo_recontratacao_automatica" class="flat-red" {{ old('modo_recontratacao_automatica', $dados->modo_recontratacao_automatica)  == 1 ? 'checked' : '' }}>
                                        Recontratar automaticamente o valor original do contrato.
                                    </label>
                                    <br>
                                    <label>
                                        <input type="radio" value="2" name="modo_recontratacao_automatica" class="flat-red" {{ old('modo_recontratacao_automatica', $dados->modo_recontratacao_automatica)  == 2 ? 'checked' : '' }}>
                            ...
                            <div class="box-body">
                                ...
                                @if($sistema->sistema_saude)
                                    <div class="form-group col-xs-12">
                                        ...
                                        <select class="form-control select2" name="tipo_pacote"
                                                data-placeholder="Selecione uma categoria" style="width: 100%;">
                                            <option @if(old('tipo_pacote', $dados->tipo_pacote) == 1) selected @endif value="1">
                                                Gold
                                            </option>
                                            <option @if(old('tipo_pacote', $dados->tipo_pacote) == 2) selected @endif value="2">
                                                Platinum
                                            </option>
                                            <option @if(old('tipo_pacote', $dados->tipo_pacote) == 3) selected @endif value="3">
                                                Black
                                            </option>
                                            <option @if(old('tipo_pacote', $dados->tipo_pacote) == 4) selected @endif value="4">
                                                Empresarial
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="valor_consulta"
                                               value="{{ old('valor_consulta', $dados->valor_consulta) }}">
                                    </div>

                                    <div class="form-group col-xs-12">
                                        <label>Valor da fisioterapia</label><br>
                                        <input type="text" class="form-control" name="valor_fisioterapia"
                                               value="{{ old('valor_fisioterapia', $dados->valor_fisioterapia) }}">
                                    </div>
                                @endif
                                ...
                                @if($sistema->sistema_saude)
                                    <div class="form-group col-xs-12">
                                        ...
                                        <textarea class="textarea" id="descricao_impressao" name="descricao_impressao"
                                                  ...
                                                  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('descricao_impressao', $dados->descricao_impressao) }}</textarea>
                                    </div>
                                @endif
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            $("input[name*='faixa_deposito_'").maskMoney().maskMoney('mask');
