                        ...
                        <table id="tabela_index" class="table table-bordered table-striped">
                            ...
                            @foreach($dados as $dd)
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" id="formDel" action="{{ route('role.destroy', $dd->id) }}">
                                            {!! csrf_field() !!}
                                            <div class="btn-group" role="group" aria-label="Botões de Ação">
                                                <a title="Editar" class="btn btn-default btn-sm" href="{{ route('role.edit', $dd->id) }}">
                                                    <span class="glyphicon glyphicon-edit text-success" aria-hidden="true"></span>
                                                </a>
                                                <a title="Desativar" class="btn btn-default btn-sm" href="{{ route('role.delete', $dd->id) }}">
...
@section('script')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('<div class="btn-group"><a href="{{ route('role.create') }}" class="btn btn-primary">Novo</a></div>').appendTo('div.box-btn');
        })
    </script>
@endsection