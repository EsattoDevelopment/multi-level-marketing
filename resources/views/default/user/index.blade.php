    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#tabela_index').DataTable({
                ...
                responsive: true,
                searchDelay: 500,
                ajax: '{!! route('user.index.json') !!}',
                columns: [
                    {data: 'id', name: 'u.id'},
                    {data: 'name', name: 'u.name'},
                    //{data: 'username', name: 'u.username'},
                    {data: 'titulo', name: 't.name'},
                    //{data: 'tipo', name: 'u.tipo'},
                    {data: 'email', name: 'u.email'},
                    {data: 'telefone', name: 'u.celular'},
                    {data: 'conta', name: 'u.conta'},
                    {data: 'indicador', name: 'i.name'},
                    {data: 'dt_cadastro', name: 'u.created_at'},
