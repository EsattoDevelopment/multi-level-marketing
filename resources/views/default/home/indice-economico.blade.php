            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Gráficos de Moedas</h3>
                    </div>
                    <div class="box-body ">
                        <iframe height="355" width="100%" src="https://sslcharts.forexprostools.com/index.php?force_lang=12&pair_ID=1&timescale=300&candles=50&style=candles"></iframe>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
