                                                ...
                                                <td>
                                                    <form method="post" id="formDel_{{ $dd->id }}" action="{{ route('download.destroy', $dd->id) }}">
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Botões de Ação">
                                                            <a title="Editar" class="btn btn-default btn-sm" href="{{ route('download.edit', $dd->id) }}">
                                                                <span class="glyphicon glyphicon-edit text-success" aria-hidden="true"></span>
                                                            </a>
                                                            <a title="Desativar" class="btn btn-default btn-sm" href="{{ route('download.delete', $dd->id) }}">
                        ...
                        <div class="tab-pane" id="desativados">
                            <div class="box">
                                <div class="box-header text-danger">
                                    Lista de Downloads desativadas
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="post" id="formDel_{{ $dd->id }}" action="{{ route('download.destroy', $dd->id) }}">
                                                        {!! csrf_field() !!}
                                                        <div class="btn-group" role="group" aria-label="Botões de Ação">
                                                            <a title="Ativar" class="btn btn-default btn-sm" href="{{ route('download.recovery', $dd->id) }}">
