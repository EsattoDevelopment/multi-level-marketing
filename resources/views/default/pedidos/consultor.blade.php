                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('portfolio.contratar') }}" id="form-pedido-{{ $item->id }}" class="form-contratacao"  method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="checkbox" name="aceite" @click="aceite = !aceite" v-model="aceite_{{ $item->id }}"> Li as informações e estou de acordo
    ...
    <script>
        $(function () {
            ...
            $("div[id*='modal-item-']").on('show.bs.modal', function (e) {
                ...
                //     swal({
                //         title: "",
                //         text: "O <b>valor</b> deve respeitar a <b>Faixa de Depósito</b>!",
                //         type: "warning",
                //         html: true,
                //     });
                //
