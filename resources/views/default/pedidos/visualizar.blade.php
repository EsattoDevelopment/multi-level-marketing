            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">{{ $header }} #{{ $dados->id }}</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            @if(isset($metodoPagamento))
                                <div class="col-md-12">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        {{--<p>Infelizmente, o Paypal não processa pagamentos em BRL. Sua compra será feita em USD.</p>
                                                        <p>Valor que será cobrado de você pelo Paypal: US$6.</p>--}}
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default pull-left modal-cancelar" data-dismiss="modal">Cancelar</button>
                                    ...
                                    @if((Auth::user()->ultimoMovimento() ? Auth::user()->ultimoMovimento()->saldo : 0) >= $dados->valor_total)
                                        <form action="{{ route('pedido.usuario.pedido.pagar.saldo', [Auth::user()->id, $dados->id]) }}" method="post">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="metodo_pagamento" value="6">
                                            <input type="hidden" name="pedido_id" value="{{ $dados->id }}">
                                            <button class="btn bg-green-active text-black botao-pagamento"><span class="fa fa-money"></span> Pagar com saldo</button>
                                        </form>
                                    @endif
                                </div>
                            @endif
                    ...
                    <div class="box-footer">
                        ...
                        @else
                            <a href="{{ route('pedidos.aguardando.pagamento') }}" class="btn btn-primary pull-right">Voltar</a>
                        @endif
                    </div>
                </div><!-- /.box -->
            </div><!--/.col (left) -->
