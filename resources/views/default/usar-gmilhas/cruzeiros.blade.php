            ...
            <div class="col-md-12">
                ...
                <div class="box box-widget">
                    <div class="box-header with-border">
                        <h3 class="box-title">Cruzeiros</h3>
                    </div>
                                                                            ...
                                                                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                                                                ...
                                                                                <div class="box box-widget bg-green-gradient">
                                                                                    ...
                                                                                    <div class="box-footer bg-green-active">
                                                                                        <a href="{{ route('usar-gmilhas.cruzeiro.interna', $dd->id) }}"
                                                                ...
                                                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                                                    ...
                                                                    <div class="box box-widget bg-yellow-gradient">
                                                                        ...
                                                                        <div class="box-footer bg-yellow-active">
                                                                            <a href="{{ route('usar-gmilhas.cruzeiro.interna', $dd->id) }}" class="btn btn-primary btn-block">Visualizar</a>
                                                                        </div>
                                                                        <!-- /.box-footer -->
                                                                    </div>
                                                                    <!-- /.box -->
