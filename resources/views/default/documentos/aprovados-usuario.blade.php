...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Documentos</li>
            <li><a href="{{route('documentos.associado.aprovados')}}">Aprovados</a></li>
    ...
    <section class="content">
        ...
        <form name="doc" method="post" action="{{route('documentos.associado.aprovados.confirmacao')}}">
            {!! csrf_field() !!}
            @if($usuario != null)
            ...
            <div class="row">
                <div>
                                    ...
                                    <div class="box-body" id="identidade">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="padding-right: 25px">
                                                <input type="radio" value="1" name="documento_aprovacao" class="flat-red" {{ old('documento_aprovacao', 1)  == 1 ? 'checked' : '' }}>
                                                Aprovar
                                            </label>
                                            <label>
                                                <input type="radio" value="0" name="documento_aprovacao" class="flat-red" {{ old('documento_aprovacao', 1)  == 0 ? 'checked' : '' }}>
                                                Recusar
                                            </label>
                                            <label>
                                                <input type="radio" value="2" name="documento_aprovacao" class="flat-red" {{ old('documento_aprovacao', 1)  == 2 ? 'checked' : '' }}>
                                                Em análise
                                            </label>
                                        </div>
                                        <div class="form-group col-xs-12 hidden" id="motivo_documento_aprovacao">
                                            <label for="motivo_documento_aprovacao">Motivo</label>
                                            <input type="text" name="motivo_documento_aprovacao" value="{{ old('motivo_documento_aprovacao') }}" class="form-control" placeholder="Motivo pelo qual o documento foi recusado">
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body" id="selfie">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="padding-right: 25px">
                                                <input type="radio" value="1" name="selfie_aprovacao" class="flat-red" {{ old('selfie_aprovacao', 1)  == 1 ? 'checked' : '' }}>
                                                Aprovar
                                            </label>
                                            <label>
                                                <input type="radio" value="0" name="selfie_aprovacao" class="flat-red" {{ old('selfie_aprovacao', 1)  == 0 ? 'checked' : '' }}>
                                                Recusar
                                            </label>
                                            <label>
                                                <input type="radio" value="2" name="selfie_aprovacao" class="flat-red" {{ old('selfie_aprovacao', 1)  == 2 ? 'checked' : '' }}>
                                                Em análise
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body" id="endereco">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="padding-right: 25px">
                                                <input type="radio" value="1" name="endereco_aprovacao" class="flat-red" {{ old('endereco_aprovacao', 1)  == 1 ? 'checked' : '' }}>
                                                Aprovar
                                            </label>
                                            <label>
                                                <input type="radio" value="0" name="endereco_aprovacao" class="flat-red" {{ old('endereco_aprovacao', 1)  == 0 ? 'checked' : '' }}>
                                                Recusar
                                            </label>
                                            <label>
                                                <input type="radio" value="2" name="endereco_aprovacao" class="flat-red" {{ old('endereco_aprovacao', 1)  == 2 ? 'checked' : '' }}>
                                                Em análise
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body" id="identidade">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="padding-right: 25px">
                                                <input type="radio" value="1" name="responsavel_documento_aprovacao" class="flat-red" {{ old('responsavel_documento_aprovacao', 1)  == 1 ? 'checked' : '' }}>
                                                Aprovar
                                            </label>
                                            <label>
                                                <input type="radio" value="0" name="responsavel_documento_aprovacao" class="flat-red" {{ old('responsavel_documento_aprovacao', 1)  == 0 ? 'checked' : '' }}>
                                                Recusar
                                            </label>
                                            <label>
                                                <input type="radio" value="2" name="responsavel_documento_aprovacao" class="flat-red" {{ old('responsavel_documento_aprovacao', 1)  == 2 ? 'checked' : '' }}>
                                                Em análise
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body" id="selfie">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="padding-right: 25px">
                                                <input type="radio" value="1" name="responsavel_selfie_aprovacao" class="flat-red" {{ old('responsavel_selfie_aprovacao', 1)  == 1 ? 'checked' : '' }}>
                                                Aprovar
                                            </label>
                                            <label>
                                                <input type="radio" value="0" name="responsavel_selfie_aprovacao" class="flat-red" {{ old('responsavel_selfie_aprovacao', 1)  == 0 ? 'checked' : '' }}>
                                                Recusar
                                            </label>
                                            <label>
                                                <input type="radio" value="2" name="responsavel_selfie_aprovacao" class="flat-red" {{ old('responsavel_selfie_aprovacao', 1)  == 2 ? 'checked' : '' }}>
                                                Em análise
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body" id="endereco">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="padding-right: 25px">
                                                <input type="radio" value="1" name="responsavel_documento_legal_aprovacao" class="flat-red" {{ old('responsavel_documento_legal_aprovacao', 1)  == 1 ? 'checked' : '' }}>
                                                Aprovar
                                            </label>
                                            <label>
                                                <input type="radio" value="0" name="responsavel_documento_legal_aprovacao" class="flat-red" {{ old('responsavel_documento_legal_aprovacao', 1)  == 0 ? 'checked' : '' }}>
                                                Recusar
                                            </label>
                                            <label>
                                                <input type="radio" value="2" name="responsavel_documento_legal_aprovacao" class="flat-red" {{ old('responsavel_documento_legal_aprovacao', 1)  == 2 ? 'checked' : '' }}>
                                                Em análise
                                            </label>
                                        </div>
                    ...
                    @if($usuario != null)
                        @if($usuario->getRelation('dadosBancarios')->where('status_comprovante', 'validado')->count() > 0)
                            <div class="col-md-12">
                                <h3>
                                    <span class="text-red">Dados Bancários</span>
                                </h3>
                            </div>
                            @foreach($usuario->getRelation('dadosBancarios')->where('status_comprovante', 'validado') as $conta)
                                <div class="col-md-4">
                                    <div class="box box-default">
                                        <div class="box-body box-profile">
                                            ...
                                            <div class="form-group col-xs-12">
                                                <label style="padding-right: 25px">
                                                    <input type="radio" value="1" name="banco_aprovacao[{{$conta->id}}]" class="flat-red" checked>
                                                    Aprovar
                                                </label>
                                                <label>
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('documentos.associado.aprovados') }}" class="btn btn-danger btn-block"><i class="fa fa-mail-reply-all"></i><b> Voltar</b></a>
                    </div>
                </div>
            </div>
        </form>
