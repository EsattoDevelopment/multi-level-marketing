<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview @if(strpos(Route::currentRouteName(), 'saude.medicos.index.clinica') !== false)) active @endif">
                <a href="{{ route('saude.medicos.index.clinica') }}">
            ...
            <li class="treeview @if(strpos(Route::currentRouteName(), 'procedimentos_clinica') !== false)) active @endif">
                <a href="{{ route('saude.procedimentos_clinica.index', [Auth::user()->id]) }}">
