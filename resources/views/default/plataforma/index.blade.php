                                                ...
                                                <td>
                                                    <form method="post" id="formDel_{{ $dd->id }}" action="{{ route('plataforma.destroy', $dd->id) }}">
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Botões de Ação">
                                                            <a title="Contas" class="btn btn-default btn-sm" href="{{ route('plataforma-conta.show', $dd->id) }}">
                                                                <span class="fa fa-bank text-blue" aria-hidden="true"></span>
                                                                <span class="badge bg-red">{{ $dd->contasCount()}}</span>
                                                            </a>
                                                            <a title="Editar" class="btn btn-default btn-sm" href="{{ route('plataforma.edit', $dd->id) }}">
                                                                <span class="glyphicon glyphicon-edit text-success" aria-hidden="true"></span>
                                                            </a>
                                                            <a title="Desativar" class="btn btn-default btn-sm" href="{{ route('plataforma.desativar', $dd->id) }}">
                        ...
                        <div class="tab-pane" id="desativados">
                            <div class="box">
                                <div class="box-header text-danger">
                                    Lista de Plataformas desativadas
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post" id="formDel_{{ $dd->id }}" action="{{ route('plataforma.destroy', $dd->id) }}">
                                                            {!! csrf_field() !!}
                                                            <div class="btn-group" role="group" aria-label="Botões de Ação">
                                                                <a title="Ativar" class="btn btn-default btn-sm" href="{{ route('plataforma.ativar', $dd->id) }}">
...
@section('script')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('<div class="btn-group"><a href="{{ route('plataforma.create') }}" class="btn btn-primary">Novo</a></div>').appendTo('div.box-btn');
        })
    </script>
@endsection