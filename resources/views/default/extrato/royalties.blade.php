...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Extrato de royalties recebidos<br>
        ...
        <ol class="breadcrumb">
            ...
            <li>Extrato</li>
            <li class="active">Extrato de royalties ganhos</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <strong>Total recebido {{ mascaraMoeda($sistema->moeda, $ganhos->sum('valor_manipulado'), 2, true) }}</strong><br>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
