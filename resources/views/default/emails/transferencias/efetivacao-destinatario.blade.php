        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin: 0;"><b>Você recebeu uma transferência de:</b></p>

                        <p>
                            {{ $transferencia->usuario->name }} <br>
                            <b>Agência</b>: 0001 <br>
                            <b>Conta</b>: {{ $transferencia->usuario->conta }} <br><br>

                            no valor de <br>
                            <h1>{{ mascaraMoeda('R$', $transferencia->valor, 2, true) }}</h1>
                        </p>
                    <p><b>Efetivada em</b>: {{ $transferencia->dt_efetivacao->format('d/m/Y H:i:s') }} <b></b></p>
