...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
  Esta é uma notificação de solicitação de transferência realizado em sua conta {{ mb_strtoupper(env('COMPANY_NAME_SHORT', 'empresa')) }}. Você está recebendo este e-mail para garantir que a operação foi feito por você.
</div>
<!-- end preheader -->
@endsection
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #ae903e;">
                    <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Solicitação de transferência de
                        <br> {{ $user->name }},</h1>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    ...
                    @if($transferencia->destinatario_user_id)
                        <p style="margin: 0;"><b>Transferência entre contas {{ ucfirst(env('COMPANY_NAME_SHORT', 'empresa')) }}:</b></p>

                        <p>
                            <b>Valor:</b> {{ mascaraMoeda($sistema->moeda, $transferencia->valor, 2, true) }}
                        </p>
                        <p>
                    ...
                    @else
                        <p>
                            no valor de <br>
                            <h1>{{ mascaraMoeda($sistema->moeda, $transferencia->valor, 2, true) }}</h1> <br><br>
