...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Parabéns {{ ucfirst(explode(' ', $dados->name)[0]) }}, você completou seu cadastro na {{ env('COMPANY_NAME', 'empresa') }}.
</div>
<!-- end preheader -->
@endsection
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #ae903e;">
                    <h1 style="margin: 0; font-size: 32px; font-weight: 400; letter-spacing: -1px; line-height: 48px;">Parabens <b>{{ ucfirst(explode(' ', $dados->name)[0]) }}</b>,</h1>
                </td>
            </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin: 0;">Estamos muito felizes que tenha terminado o seu cadastro, agora você pode utilizar plenamente a sua <b>carteira</b>.
                        <br></p>
