...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Olá {{ $dados->nomeUsuario }}, Parabéns, o seu contrato {{ $dados->nomeContrato }} Nº {{ $dados->idContrato }} foi quitado e finalizado!
</div>
<!-- end preheader -->
@endsection
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin: 0;">Realizamos o pagamento final e quitação integral de seu Contrato de Mútuo nº <b>{{$dados->idContrato}}</b> - plano <b>{{$dados->nomeContrato}}</b></p>
                    <p>Com isso, creditamos o valor restante da operação contratual direto para a sua CARTEIRA!</p>
                    <p>O seu dinheiro já está disponível para você usar como preferir!</p>
                    <p>
                        Você já conhece o CAP-30 mensal? Que tal contratar um agora? <br>

                        Acesse sua conta, confira seu saldo disponível e escolha um de nossos planos fenomenais <br>
                    </p>
