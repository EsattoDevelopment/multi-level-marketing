...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Olá {{ $nome_usuario }}, recebemos seu comprovante referente ao pedido <b>#{{ $pedido }}</b> <br> e nossa equipe já está analisando.
</div>
<!-- end preheader -->
@endsection
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin: 0;">Recebemos seu comprovante referente ao pedido <b>#{{ $pedido }}</b> <br> e nossa equipe já está analisando.</p>
