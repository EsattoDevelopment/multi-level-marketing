...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Olá {{ $nome_usuario }}, Parabéns! Acabamos de lançar mais uma atualização de capital no seu contrato!
</div>
<!-- end preheader -->
@endsection
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin: 0;">Parabéns! Acabamos de lançar mais uma atualização de capital no seu contrato nº <b>{{ $contrato }}</b> - <b>{{ $item }}</b>!</p>
                    <p>Percentual de hoje: <b>{{ $percentual }}%</b></p>
                    <p>Valor da correção do capital hoje: <b>{{ mascaraMoeda($sistema->moeda, $valor, 2, true) }}</b></p>
                    <p>Para conferir seu extrato detalhado acesse sua carteira.</p>
                    <p style="width: 50%; border-radius: 6px; background: #ae903e">
                        <a href="{{ route('capitalizacao.index') }}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Acessar</a>
                    </p>
