...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Parabéns! O seu depósito já foi confirmado por nossa equipe, e o valor já está disponível em sua conta.
</div>
<!-- end preheader -->
@endsection
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin-top: 0;">Parabéns! O seu depósito já foi confirmado por nossa equipe, e o valor já está disponível em sua conta.</p>
                    <p style="width: 50%; border-radius: 6px; background: #ae903e">
                      <a href="{{ route('extrato.financeiro') }}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; color: #ffffff; text-decoration: none; border-radius: 6px;">Acessar Minha Conta</a>
                    </p>
                    <p>Registro de Documento nº <b>#{{ $pedido }}</b>.</p>
