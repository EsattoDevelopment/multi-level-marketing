...
var _indicador = require('../../views/user/components/indicador.vue');

var _indicador2 = _interopRequireDefault(_indicador);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(_vueResource2.default);

_vue2.default.component('v-indicador', _indicador2.default);
...
new Vue({
    ...
    methods: {
        getOptions(search, loading) {
            loading(true)
            this.$http.get('http://localhost:8000/api/user/busca', {
                search: search
            }).then((resp) => {
...
},{"../../views/user/components/indicador.vue":6,"vue":4,"vue-resource":3}],6:[function(require,module,exports){
'use strict';
...
exports.default = {
    props: ['users', 'patrocinio'],

    method: {
        onChange: function onChange(value) {
            window.console.log(value);
            //this.$http.get('http://localhost:8000/api/user/busca').then((req) => this.users = req.data);
        }
    },
    ...
    ready: function ready() {
        ...
        this.$http.get('http://localhost:8000/api/user/busca').then(function (req) {
            return _this.users = req.data;
        });
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <div class=\"form-group\">\n        <label>Indicador</label>\n        <select class=\"form-control select2\" name=\"indicador\" data-placeholder=\"Selecione um indicador\" style=\"width: 100%;\">\n            <option v-for=\"u in users\" selected=\"{{ u.id == patrocinio }}\" value=\"{{ u.id }}\">#{{ u.id }} - {{ u.name }}</option>\n        </select>\n\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-56aafe78", module.exports)
  } else {
    hotAPI.update("_v-56aafe78", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
